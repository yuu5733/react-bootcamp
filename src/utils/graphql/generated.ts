...
export type UserByIdQuery = { __typename?: 'query_root', users_by_pk?: Maybe<{ __typename?: 'users', id: string, name: string, profile_photo_url: string, created_at: any, updated_at: any }> };
